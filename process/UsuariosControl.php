...
if ($num_rows > 0) {
    while ($row = $resultado->fetch(PDO::FETCH_ASSOC)) {
        ...
        $output['data'] .= '<td><a class="btn btn-warning btn-sm" href="?sec=UsuarioAddEdit&id=' . $row['ID'] . '">
            <i class="ri-edit-2-fill"></i> Editar</a></td>';
        $output['data'] .= '<td><a class="btn btn-danger btn-sm" onclick="confirmDeshabilitar(' . $row['ID'] . ')">
