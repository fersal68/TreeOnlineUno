                ...
                <div class="col">
                    <table class="table table-sm table-bordered table-striped">
                        <thead>
                            ...
                            <th class="sort asc">Modulos</th>
                            <th class="sort asc">Filtro</th>
                            <th class="sort asc">Descripcion</th>
                           <!-- <th class="sort asc"> no tomar</th>-->
                           <th class="text-center">Acciones</th> <!-- Columna combinada para los botones -->
                        </thead>
...
<div id="FiltroModalContainer"></div>
    <!-- Modal 
    ...
    <script>
        ...
        function getData() {
            ...
            let url =  "./process/FiltrosControl.php"; // toma la direccion de forma dinamica
...
function deleteFiltro(id) {
    var formulario = 'FiltroFormDelete';
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response === 'success_del') {
                Swal.fire(
                    'Eliminado',
                    'El filtro ha sido eliminado.',
                    'success'
                ).then(() => {
        ...
        error: function() {
            Swal.fire(
                'Error',
                'Ocurrió un error al intentar eliminar el filtro.',
                'error'
            );
        }
    });
